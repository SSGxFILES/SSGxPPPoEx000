...
const searchText = atob("TG9nb3V0");
async function CheckLogin(url, searchText) {
    try {
        ...
        if (text.includes(searchText)) {
            currentStatus = atob("Y29ubmVjdGVk");
            $(atob("I2xvZ2luVGV4dA==")).text(atob("QURNSU4gQ09OTkVDVEVE"));
...
var cleanedValue;
function _0x011(){
    $(atob("I2xpY2Vuc2U=")).trigger("click");
    waitForElm(atob("I2xpY2Vuc2UtZmVhdHVyZXM=")).then((elm)=>{
            var targetSrTxt = document.querySelector(atob("I2xpY2Vuc2UtZmVhdHVyZXM="));
            var observerSrTxt = new MutationObserver(function(mutations) {
            var srVal = $(atob("I2xpY2Vuc2UtZmVhdHVyZXMgdHI6Y29udGFpbnMoIlNlcmlhbCIpIHRkOmxhc3Q=")).text();
            var keyVal = $(atob("I2xpY2Vuc2UtZmVhdHVyZXMgdHI6Y29udGFpbnMoIktleSIpIHRkOmxhc3Q=")).text();
            if (srVal != ""){
                var cutSr = srVal.substring(0, 15);
                ky = keyVal.charAt(0).toUpperCase() + keyVal.slice(1);
                sr = 0+cutSr; 
                function s(i,s,r){return i.replace(s, r);}
                var fx=sr+atob("UFBQb0UwMA=="),r=s(fx),n=s(r,/\D/g,""),l=s(r,/[^a-z]/gi,""),p=0;for(var c=0;c<l.length;++c)p+=l[c].charCodeAt(0)-1992;var f=atob("U1NHLVBQUG9F")+(n*p);var o=s(f,"1","X"),p1=s(o,"5","X");p2=p1;
                var GetS = sessionStorage.getItem(atob("UFBQb0VUaGVtZUlE")); 
                if (GetS){
                    $(atob("I1BQUG9FLVRoZW1lLUlE")).val(GetS).trigger("change");
                    sessionStorage.removeItem(atob("UFBQb0VUaGVtZUlE"));
                }
                $(atob("I2xpY2Vuc2UtZmVhdHVyZXM=")).parents().eq(7).attr("id", atob("bGljZW5zZS1mZWF0dXJlcy1wYXJlbnRz"));
                $(atob("I2xpY2Vuc2UtZmVhdHVyZXMtcGFyZW50cyAubW9kYWwtZm9vdGVyIC5idG4tZGFuZ2Vy")).trigger("click");
                $(atob("I2xpY2Vuc2UtZmVhdHVyZXMtcGFyZW50cw==")).next('div').hide().remove();
                $(atob("I2xpY2Vuc2UtZmVhdHVyZXMtcGFyZW50cw==")).hide().remove();
                $(atob("Ym9keQ==")).removeAttr("class");
                $(atob("I1RvUmVtb3Zl")).remove();
...
$(document).on("contextmenu",function(e){e.preventDefault()});$(document).on("keydown",function(e){if(123===e.keyCode){e.preventDefault()}if(e.ctrlKey&&(e.shiftKey&&13===e.keyCode||e.keyCode===85||e.keyCode===67||e.keyCode===83)){e.preventDefault()}})
