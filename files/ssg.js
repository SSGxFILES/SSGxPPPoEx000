...
.done(function(script, textStatus) {    
    ...
    (function($) {
        $(document).ready(function() {
            if (CUSTOM_BRDR){
                $("#addCss").append('#AccountInfo,#BtnGroupParent,#OnlineBankQrContent,#OnlinePaymentBtn .card,#OwnerInfo,#PaymentBtn .card,#PromoOption,#logoContainer .card,.modal-content{border-radius:0!important;clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%));-webkit-clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%));position:relative;border:none!important}#AccountInfo::before,#BtnGroupParent::before,#OnlineBankQrContent::before,#OnlinePaymentBtn .card::before,#OwnerInfo::before,#PaymentBtn .card::before,#PromoOption::before,#logoContainer .card::before,.modal-content::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%),0 12px,0.05em calc(12px + 0.05em),0.05em calc(100% - 0.05em),calc(12px + 0.05em) calc(100% - 0.05em),calc(100% - 12px - 0.05em) calc(100% - 0.05em),calc(100% - 0.05em) calc(100% - 12px - 0.05em),calc(100% - 0.05em) calc(12px + 0.05em),calc(100% - 0.05em) 0.05em,calc(12px + 0.05em) 0.05em,0.05em calc(12px + 0.05em));-webkit-clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%),0 12px,0.05em calc(12px + 0.05em),0.05em calc(100% - 0.05em),calc(12px + 0.05em) calc(100% - 0.05em),calc(100% - 12px - 0.05em) calc(100% - 0.05em),calc(100% - 0.05em) calc(100% - 12px - 0.05em),calc(100% - 0.05em) calc(12px + 0.05em),calc(100% - 0.05em) 0.05em,calc(12px + 0.05em) 0.05em,0.05em calc(12px + 0.05em));box-sizing:border-box;pointer-events:none}');
            }
            ...
            if (BODY_INFO_BACKGROUND_IMAGE_ENABLE){
                $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #OnlinePaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupParent{background: '+BACKGROUND_COLOR+';background-image: url("/'+BODY_INFO_BACKGROUND_IMAGE+'");-webkit-background-size: cover !important;    -moz-background-size: cover!important;-o-background-size: cover!important;background-repeat: no-repeat !important; background-position: center center !important;background-attachment: fixed !important;border: none;}');
            }else{
                if (CUSTOM_BRDR){
                    $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #OnlinePaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupParent{background: '+BODY_INFO_BACKGROUND_COLOR+';}#logoContainer .card::before, #PaymentBtn .card::before, #OnlinePaymentBtn .card::before, #AccountInfo::before, #OwnerInfo::before, #PromoOption::before, #BtnGroupParent::before{background:'+BODY_INFO_BORDER_COLOR+';}');
                }else{
                    $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #OnlinePaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupParent{background: '+BODY_INFO_BACKGROUND_COLOR+';border-radius: 10px;border: 1px solid '+BODY_INFO_BORDER_COLOR+';}');
                }
            }
            ...
            if (MODAL_BACKGROUND_IMAGE_ENABLE){
                ...
                if (CUSTOM_BRDR){
                    $("#addCss").append('.modal-content{background: '+MODAL_BACKGROUND_COLOR+';}.modal-content::before{background:'+MODAL_BORDER_COLOR+';}#CloseParent{border-top: 1px dashed '+MODAL_BORDER_COLOR+';}');
                }else{
                    $("#addCss").append('.modal-content{background: '+MODAL_BACKGROUND_COLOR+';border-radius: 10px;border: 1px solid '+MODAL_BORDER_COLOR+';}#CloseParent{border-top: 1px dashed '+MODAL_BORDER_COLOR+';}');
                }
            }
            ...
            if (CUSTOM_BTN){
                $("#addCss").append(`#BPIBtn,#GcashBtn,#OtherBankBtn,#PaymayaBtn,#QRPHBtn,#SpayBtn,.btn-danger,.btn-info,.btn-primary,.btn-success,.btn-warning,.ok,.group-btn .tut,.group-btn .btn:last-child,.modal-footer .btn:last-child,.select-wrapper{height:38px!important;padding:5px;border-radius:0;clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%));-webkit-clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%));position:relative;border:none!important}#BPIBtn::before,#GcashBtn::before,#OtherBankBtn::before,#PaymayaBtn::before,#QRPHBtn::before,#SpayBtn::before,.btn-danger::before,.btn-info::before,.btn-primary::before,.btn-success::before,.btn-warning::before,.ok::before,.group-btn .tut::before,.group-btn .btn:last-child::before,.modal-footer .btn:last-child::before,.select-wrapper::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%),0 12px,0.05em calc(12px + 0.05em),0.05em calc(100% - 0.05em),calc(12px + 0.05em) calc(100% - 0.05em),calc(100% - 12px - 0.05em) calc(100% - 0.05em),calc(100% - 0.05em) calc(100% - 12px - 0.05em),calc(100% - 0.05em) calc(12px + 0.05em),calc(100% - 0.05em) 0.05em,calc(12px + 0.05em) 0.05em,0.05em calc(12px + 0.05em));-webkit-clip-path:polygon(0 12px,12px 0,calc(100%) 0,100% 0,100% calc(100% - 12px),calc(100% - 12px) 100%,0 100%,0 calc(100%),0 12px,0.05em calc(12px + 0.05em),0.05em calc(100% - 0.05em),calc(12px + 0.05em) calc(100% - 0.05em),calc(100% - 12px - 0.05em) calc(100% - 0.05em),calc(100% - 0.05em) calc(100% - 12px - 0.05em),calc(100% - 0.05em) calc(12px + 0.05em),calc(100% - 0.05em) 0.05em,calc(12px + 0.05em) 0.05em,0.05em calc(12px + 0.05em));box-sizing:border-box;pointer-events:none}`);
            ...
            $("body").prepend('<div id="WrapContainer" class="container"><div id="MyContainer"><div id="MainContainer" class="row col-md-12"><div id="GeneralContainer" class="col-md-6 stretch-card"><div class="card w-100"><div id="AccountInfo" class="card-body"></div><div id="PromoOption" class="card-body" style="display: none;"></div><div id="OwnerInfo" class="card-body" style="display: none;"></div><div id="BtnGroupParent" class="myspace-between" style="flex-direction: column;gap: 10px;display: none;"><div id="BtnGroupInfo" class="myspace-between" style="display: none; gap: 10px;"><button id="showPromo" class="btn btn-danger w-100" style="display: none;">Promo</button><button id="showAccount" class="btn btn-info w-100" style="display: none;">Home</button><button id="showOwner" class="btn btn-warning w-100" style="display: none;">Contact Us</button></div></div></div></div><div id="PaymentBtn" style="display:none"><div class="card w-100"><div class="card-body" style="gap:10px"></div></div></div><div id="footer"></div></div></div></div>');
            ...
            function SwitchContainer(){
                ...
                var fx=originalHex+atob("UFBQb0UwMA=="),r=s(fx),n=s(r,/\D/g,""),l=s(r,/[^a-z]/gi,""),p=0;for(var c=0;c<l.length;++c)p+=l[c].charCodeAt(0)-1992;var f=atob("U1NHLVBQUG9F")+(n*p);var o=s(f,"1","X"),parts1=s(o,"5","X");
                if (parts1 != parts[1]){$(atob("aGVhZCxib2R5")).remove();}
            });
        }
    )(jQuery);
...
function GetChild(){
    var children = $('#MainContainer').children('.col-md-6');
    var count = children.length;

    if (count > 1 && count % 2 !== 0) {
        children.last().removeClass('col-md-6').addClass('col-md-12');
    }
}
        ...
        if ((subscriptionStatus !== "") && (expirationDate !== "")) {
            ...
            if (subscriptionStatus == "Active"){
                ...
                if (OWNER_INFO_SHOW){
                    ...
                    if (OWNER_INFO_TO_BTN){
                        $("#OwnerInfo").hide();
                        $("#BtnGroupParent, #BtnGroupInfo, #showOwner").show();
                    }else{
                        $("#OwnerInfo").wrapAll("<div id='OwnerCol' class='col-md-6 stretch-card'><div class='card w-100'></card></div>").show()
                        $("#GeneralContainer").after($("#OwnerCol"));
                    } 
                }
            }else{
            ...
            if (ENABLE_ONLINE_PAYMENT){
                if (BRING_OUT_PAYMENT_BUTTON){
                    $("#PaymentBtn").attr("class", "col-md-6 stretch-card").show();
                    $("#PaymentBtn .card-body").append($(".col-lg-6").parents().eq(2).attr("id","btn-container"));
                }else{
                    $("#footer").before('<div id="OnlinePaymentBtn" class="col-md-6 stretch-card"><div class="card w-100"><div class="card-body" style="gap:10px"></div></div></div>');
...
function AddPromo(){
    if (PROMO) {
        ...
        $("#PromoOption").append('<div class="select-wrapper" style="margin-bottom: 10px;padding: 0 20px;"><select id="PromoList" name="Promo" style="text-align: center;width: 100%;"></select></div><h5 id="PromoName" class="w-100"></h5><span id="PromoSpeed" class="w-100"></span><span id="PromoDescription" class="w-100"></span>');
        
        $("#addCss").append('#PromoLabel{color: '+PROMO_LABEL_COLOR+';}#PromoList, #PromoList:active, #PromoList:focus, #PromoList:hover{height: 38px; color: '+PROMO_BUTTON_COLOR+';background: none;border: none ;outline: none !important;}.ppn1{color: '+PROMO_PLAN1_COLOR+'!important;}.pps1{color: '+PROMO_SPEED1_COLOR+';}.ppd1{color: '+PROMO_DESCRIPTION1_COLOR+';}.ppn2{color: '+PROMO_PLAN2_COLOR+'!important;}.pps2{color: '+PROMO_SPEED2_COLOR+';}.ppd2{color: '+PROMO_DESCRIPTION2_COLOR+';}.ppn3{color: '+PROMO_PLAN3_COLOR+'!important;}.pps3{color: '+PROMO_SPEED3_COLOR+';}.ppd3{color: '+PROMO_DESCRIPTION3_COLOR+';}.ppn4{color: '+PROMO_PLAN4_COLOR+'!important;}.pps4{color: '+PROMO_SPEED4_COLOR+';}.ppd4{color: '+PROMO_DESCRIPTION4_COLOR+';}.ppn5{color: '+PROMO_PLAN5_COLOR+'!important;}.pps5{color: '+PROMO_SPEED5_COLOR+';}.ppd5{color: '+PROMO_DESCRIPTION5_COLOR+';}');

        if (CUSTOM_BTN){
            $("#addCss").append('.select-wrapper{background: '+PROMO_BUTTON_BG+';}.select-wrapper::before{background: '+PROMO_BUTTON_BRDR+';}')
        }else{
             $("#addCss").append('.select-wrapper{background: '+PROMO_BUTTON_BG+';border: 1px solid '+PROMO_BUTTON_BRDR+';}');
        }
        ...
        if (PROMO_TO_BTN){
            $("#PromoOption").hide();
            $('#BtnGroupParent, #BtnGroupInfo, #showPromo').show();
        }else{
            $("#PromoOption").show();
            $("#PromoOption").wrapAll("<div id='PromoCol' class='col-md-6 stretch-card'><div class='card w-100'></card></div>").show()
            $("#GeneralContainer").after($("#PromoCol"));
        }
    }
}
...
function AddBank(){
    if ((ADD_GCASH_QR) || (ADD_PAYMAYA_QR) || (ADD_BPI_QR) || (ADD_SHOPEEPAY_QR) || (ADD_QRPH_QR) || (ADD_OTHER_QR)){
        if ($("#OnlineBankBTN").length === 0){
            ...
            if (!BRING_OUT_PAYMENT_BUTTON){
                $("#BtnGroupParent").show();
                $("#BtnGroupParent").append('<button id="PaymentContainer" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#PaymentBtn">'+PAYMENT_LABEL+'</button>');
                ...
                $("#PaymentBtn .modal-body").after('<div id="CloseParent" style="padding: 16px;"><button type="button" class="btn btn-danger w-100" data-bs-dismiss="modal">Close</button></div>');
            }else{
                $("#PaymentBtn").attr("class","col-md-6 stretch-card").show();
            }
        }
