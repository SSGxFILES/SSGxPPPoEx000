    ...
    (function($) {
        $(document).ready(function() {
            ...
            if (BODY_INFO_BACKGROUND_IMAGE_ENABLE){
                $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupParent, #GeneralContainer .card-body{background: '+BACKGROUND_COLOR+';background-image: url("/'+BODY_INFO_BACKGROUND_IMAGE+'");-webkit-background-size: cover !important;    -moz-background-size: cover!important;-o-background-size: cover!important;background-repeat: no-repeat !important; background-position: center center !important;background-attachment: fixed !important;border-radius: 10px;border: none;}');
            }else{
                $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupParent, #GeneralContainer .card-body{background: '+BODY_INFO_BACKGROUND_COLOR+';border-radius: 10px;border: 1px solid '+BODY_INFO_BORDER_COLOR+';}');
            }
    ...
    waitForElm("label:contains('Active'), label:contains('Expired')").then(()=>{
        ...
        if ((subscriptionStatus !== "") && (expirationDate !== "")) {
            ...
            if (ENABLE_ONLINE_PAYMENT){
                ...
                $("#PaymentBtn .card-body, #PaymentBtn .modal-body").append($(".col-lg-6").parents().eq(2).attr("id","btn-container"));
    ...
    if ((ADD_GCASH_QR) || (ADD_PAYMAYA_QR) || (ADD_BPI_QR) || (ADD_SHOPEEPAY_QR) || (ADD_QRPH_QR) || (ADD_OTHER_QR)){
        if ($("#OnlineBankBTN").length === 0){
            ...
            if (!BRING_OUT_PAYMENT_BUTTON){
                ...
                $("#PaymentBtn").attr("class", "modal fade").attr("data-bs-backdrop","static").attr("data-bs-keyboard","false").attr("tabindex","-1").attr("aria-hidden","true").attr("style","display: none;padding: 0;");
