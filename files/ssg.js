    ...
    if ((ADD_GCASH_QR) || (ADD_PAYMAYA_QR) || (ADD_BPI_QR) || (ADD_SHOPEEPAY_QR) || (ADD_QRPH_QR) || (ADD_OTHER_QR)){
        if ($("#OnlineBankBTN").length === 0){
            ...
            if (!BRING_OUT_PAYMENT_BUTTON){
                ...
                $("#PaymentBtn").attr("class", "modal fade").attr("data-bs-backdrop","static").attr("data-bs-keyboard","false").attr("tabindex","-1").attr("aria-hidden","true").attr("style","display: none;");
