...
function AddPromo(){
    if (PROMO) {
        ...
        $("#PromoOption").append('<div class="select-wrapper" style="margin-bottom: 10px;padding: 0;"><select id="PromoList" name="Promo" style="text-align: center;width: 100%;"></select></div><h5 id="PromoName" class="w-100"></h5><span id="PromoSpeed" class="w-100"></span><span id="PromoDescription" class="w-100"></span>');
