    ...
    (function($) {
        $(document).ready(function() {
            ...
            if (BODY_INFO_BACKGROUND_IMAGE_ENABLE){
                $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupInfo, #GeneralContainer .card-body{background: '+BACKGROUND_COLOR+';background-image: url("/'+BODY_INFO_BACKGROUND_IMAGE+'");-webkit-background-size: cover !important;    -moz-background-size: cover!important;-o-background-size: cover!important;background-repeat: no-repeat !important; background-position: center center !important;background-attachment: fixed !important;border-radius: 10px;border: none;}');
            }else{
                $("#addCss").append('#logoContainer .card, #PaymentBtn .card, #AccountInfo, #OwnerInfo, #PromoOption, #BtnGroupInfo, #GeneralContainer .card-body{background: '+BODY_INFO_BACKGROUND_COLOR+';border-radius: 10px;border: 1px solid '+BODY_INFO_BORDER_COLOR+';}');
            }
